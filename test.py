...
from datasets.stenosis import make_stenosis_transform
...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='/home/pukar/Pictures/Stenosis/10390295/arcade/stenosis/sten_detr',
...
def infer(images_path, model, postprocessors, device, output_path):
    ...
    for img_sample in images_path:
        ...
        w, h = orig_image.size
        transform = make_stenosis_transform("val")
        dummy_target = {
